...
for (let i = 0; i < starWarsCharacters.length; i++) {
  switch (starWarsCharacters[i].eye_color) {
    case "blue":
      personaggiPerOcchi.blue.push(starWarsCharacters[i].name);
      break;
    case "yellow":
      personaggiPerOcchi.yellow.push(starWarsCharacters[i].name);
      break;
    case "brown":
      personaggiPerOcchi.brown.push(starWarsCharacters[i].name);
      break;
    case "red":
      personaggiPerOcchi.red.push(starWarsCharacters[i].name);
      break;
    case "blue-gray":
      personaggiPerOcchi.blueGray.push(starWarsCharacters[i].name);
      break;
  }
}
console.log("Esercizio 5", personaggiPerOcchi);
...
console.log("Esercizio 6  la massa totale è di ", crewMass + " kg");
/* ESERCIZIO 7
